      ...
      <div className="flex my-12 flex-col md:flex-row">
        <div className="w-full md:w-1/2 lg:mx-10 flex justify-center">
          <img
            ...
            alt="Oliver"
            className="h-60 w-60 hidden xl:block mx-5"
            data-aos="flip-up"
            data-aos-duration="3000"
            data-aos-once="true"
          />
          <p className="text-lg tracking-tight" data-aos="zoom-in" data-aos-once="true">
            Hello, nice to meet you! My name is Oliver Chin. Currently, I am pursuing my education at Dian Nusantara
            University, majoring in Information Technology (IT). Apart from my studies on campus, I am actively learning
            various techniques and applications related to AI tools and programming across different platforms. During
            my free time, I indulge in playing the piano and video games.
          </p>
        </div>
